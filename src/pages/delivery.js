...
export const query = graphql`
  query {
    nurseryHero:file(name: { eq: "march_25_availability_brough_plants" }) {
        childImageSharp {
          fixed(width:800) {
...
const DeliveryPage = ({data}) => {
  ...
  return (
    ...
    <Layout pageName="delivery">
      ...
      <ul>
        <li>For deliveries to the central Bay Area (areas South of Santa Rosa, Southwest of Vacaville, West of Antioch/Livermore, and North of San Jose), there is a delivery fee of 10% of the subtotal, with a minimum charge of $75.</li>
        ...
        <li>Customer assistance for unloading materials is required, and delivery is curbside.</li>
